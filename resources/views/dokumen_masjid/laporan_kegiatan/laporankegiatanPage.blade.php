    ...
    <div>
        <div class="container laporanKeuanganContainer my-4">
            ...
            <div class="d-flex justify-content-between align-items-start mb-3">
                ...
                @auth
                    @if (auth()->user()->canManageDokumen())
                        <a href="{{ route('unggahlaporankegiatan') }}" class="btn btn-success rounded-pill px-4">
            ...
            <div class="card shadow-sm rounded-card p-4">
                ...
                <form method="GET" action="{{ route('laporankegiatan') }}"
                    ...
                    <div class="input-group search-box" style="max-width:300px;">
                        ...
                        @if (request('search') || request('tahun'))
                            <a href="{{ route('laporankegiatan') }}" class="btn btn-outline-secondary">
                                Reset
                            </a>
                        @endif
                    </div>
                            ...
                            @forelse ($laporans as $laporan)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <!-- LIHAT -->
                                        <a target="_blank" href="{{ route('lihatlaporankegiatan', $laporan->id) }}"
