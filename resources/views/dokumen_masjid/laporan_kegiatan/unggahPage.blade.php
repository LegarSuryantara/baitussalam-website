    ...
    <div>
        <div class="container my-5">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="{{ route('storelaporankegiatan') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" class="form-control shadow-sm">{{ old('description') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 uploadboxcontainer">
                                ...
                                <div class="upload-box mb-2">
                                    ...
                                    <input type="file" name="file"
                                        class="d-none @error('file') is-invalid @enderror" id="fileInput">
